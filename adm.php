...
if ($_SERVER['REQUEST_METHOD']=='POST') {
 ...
 echo "inhere";
  ...
  $studname = mysqli_real_escape_string($conn, $_POST['sname']);
  $fathname = mysqli_real_escape_string($conn, $_POST['fname']);
  $address = mysqli_real_escape_string($conn, $_POST['add']);
  $gender = mysqli_real_escape_string($conn, $_POST['gen']);
  $course = mysqli_real_escape_string($conn, $_POST['cou']);
  $program = mysqli_real_escape_string($conn, $_POST['ip']);
  $smobile = mysqli_real_escape_string($conn, $_POST['mob']);
  $fmobile = mysqli_real_escape_string($conn, $_POST['fmob']);
  $email = mysqli_real_escape_string($conn, $_POST['email']);
  $username = mysqli_real_escape_string($conn, $_POST['uname']);
  $password_1 = mysqli_real_escape_string($conn, $_POST['pwd']);
  $password_2 = mysqli_real_escape_string($conn, $_POST['cpwd']);
